...
import { addProductQuantity, removeItem } from '../Redux/cartSlice';
          ...
          return (
            <div className='flex justify-between mb-4 items-center' key={elm.id}>
              ...
              <div className='flex'>
                ...
                <button className='px-4 py-1 bg-gray-600 text-xl font-bold text-white'>-</button>
                <input type="number" className='w-[40px] border' value={elm} />
                <button className='px-4 py-1 bg-gray-600 text-xl font-bold text-white'
                  onClick={() => dispatch(addProductQuantity(elm.id))}>+</button>
              </div>
